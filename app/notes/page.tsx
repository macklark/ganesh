  ...
  return (
    <main className="flex flex-col items-center pt-24 sm:pt-28 px-4">
      <div className="w-full max-w-2xl">
        ...
        <h2 className="text-3xl sm:text-4xl text-black">Learnings</h2>
      </div>
      ...
      <div className="w-full max-w-2xl mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
        {notes.map(({ title, description, link }) => (
          <Link
            ...
            className="flex flex-col gap-3 p-4 border border-black/10 hover:border-black/25 rounded-lg transition-colors"
          >
